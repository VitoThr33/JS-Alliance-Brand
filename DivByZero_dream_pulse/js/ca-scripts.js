...
function hideElement() {
 ...
 function addText() {
    ...
    let introp1=document.getElementById('intropara1')
    ...
    let introp2=document.getElementById('intropara2')
    introp2.textContent= "The company is a leader in P.C. Manufacturing"
    ...
    let addpara=document.getElementById('addresspara')
    addpara.textContent= "1-800-565-5656"
}; 
